...
output:
  pdf_document:
   ...
   #template: ~/Dropbox/Nomogram/nomogram/svm-latex-ms.tex
word_document: 
html_document:
     #toc: true
     toc_depth: 2
...
- \linenumbers
linestretch: 2
Keywords:  "Obstetrics and Gynecology, residency"
#https://github.com/StirlingCodingClub/Manuscripts_in_Rmarkdown/blob/master/ms.Rmd
#http://svmiller.com/blog/2016/02/svm-r-markdown-manuscript/
---
*Tyler M. Muffly, Merdith Alston, Jill Liss, Georg Kropat, Janet Corral, Christine Raffaelli, Eric Jelovsek*
...
The data set of years 2015, 2016, 2017, and 2018 applicants to the University of Colorado OBGYN residency. Applicants who were in the SOAP and applied to the preliminary spot were determined to be unmatched.  The data is contained in a data frame called 'all_data'.

```{r global_options and defining paths based on working director, include=FALSE}
...
```{r Download cleaned data from Dropbox, echo=FALSE, include=FALSE}
## Here are the data
URL <- "https://www.dropbox.com/s/qbykb8sl2c8z3me/all_years_filter_111.rds?raw=1"

## NB this takes some time, the zip is about 170mb and the uncompressed file is about 700mb.
download.file(url = URL, destfile = "all_years_filter_111.rds", method = "curl")

# read in data
all_data <- 
  read_rds(paste0(data_folder,"all_years_filter_111.rds")) %>%
...
```{r Using the Drake package here for efficiency, echo=FALSE}
# Using the Drake package here for efficiency.  
file.exists(paste0(data_folder, "all_years_filter_111.rds"))
...
```{r, Data size and structure EDA, results="asis", echo=FALSE}
...
#Univariate Analysis
```{r DataExplorer EDA, results='asis', echo=FALSE, include=TRUE}
...
```{r ggpairs, warning=F, message=FALSE, include=TRUE, echo=FALSE}
all_data_ggally <- 
...
# plot
fancyRpartPlot(t.model, caption = "")
```
