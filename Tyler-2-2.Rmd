...
```{r DataExplorer, results='asis', echo=FALSE, include=TRUE, align = 'left'}
#Univariate Analysis
...
```{r ggpairs, warning=F, message=FALSE, include=TRUE, echo=FALSE, align = 'left'}
all_data_ggally <- 
...
# 
# print(summary(table1_all_data, 
#         text=T, 
#         title = 'Table 1:  Applicant Descriptive Variables by Matching Success or Failure from 2015 to 2018',
#         pfootnote=TRUE))
```

```{r Descriptive summaries of all variables in the dataset are provided in the table, results = "asis", include=TRUE}
