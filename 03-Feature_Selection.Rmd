...
In order to reduce 30 dimensions or knowing the significant impact of our reduction we will do PCA.
...
model_mars = caret::train(Match_Status ~ ., data=all_data, method='earth')
model_mars
...
varimp_mars <- caret::varImp(model_mars)
...
I am selecting variables with `all_data`.
