...
stargazer::stargazer(test.df.binned, header=FALSE, title = "Descriptive Statistics of Binned Training Match_Status Data", type='html', nobs = TRUE, mean.sd = TRUE, median = TRUE, iqr = TRUE, digits = 1, font.size = "small", flip = FALSE)
```
