...
# Tree visualization
rpart.plot::rpart.plot(t.model,yesno = 2, type = 5, extra = +100, fallen.leaves = TRUE, varlen = 0, faclen = 0, roundint = TRUE, clip.facs = TRUE, shadow.col = "gray", main = "Tree Model of Medical Students Matching into OBGYN Residency\n(Matched or Unmatched)", box.palette = c("red", "green"))
...
```{r}
plotcp(t.model)
pruned.t.model <- prune(t.model, cp = 0.005) #Set the cp where the complexity to accuraty rate plateaued.  
rpart.plot::rpart.plot(pruned.t.model,yesno = 2, type = 5, extra = +100, fallen.leaves = TRUE, varlen = 0, faclen = 0, roundint = TRUE, clip.facs = TRUE, shadow.col = "gray", main = "Tree Model of Medical Students Matching into OBGYN Residency\n(Matched or Unmatched)", box.palette = c("red", "green"))
```
