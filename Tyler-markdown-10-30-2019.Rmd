...
Here the code is creating a vector called predictorsNames so that we can reuse the model by changing the variables in predictorsNames in the future prn. 
...
#Use Model to predict match Status for Test Data
prob <- 
  predict(test.glm.with.lasso.variables, newdata = test, type="response")
dim(test)
...
ggplot(roc.data, aes(x=fpr, ymin=0, ymax=tpr)) +
  ...
  labs(title = paste0("ROC Curve with area under the curve = ", auc),
       subtitle = "Model: test.glm.with.lasso.variables")
```
