...
# Review the final variables from Boruta
```{r}
print(final_formula)
```

# 1) Model: General logistic regression model Use Model to predict match for Test Data
Shift Gears: Test Accuracy of Model on Training Data, Use glmnet model on 207 and 2018 `test` data.    
