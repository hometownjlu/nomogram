...
In conclusion, we developed a novel machine learning risk assessment tool for the prediction of matching into obstetrics and gynecology residency. Our algorithm, which includes applicant demographics, educational preparations, and research accomplishments, can be used to identify applicants at high risk for not matching.   Implementation of such risk tools no additional testing or efforts for the applicants. In the future, we will pair this algorithm with early career counseling to improve outcomes in applicants who are not likely to match.  
