...
Introduction
===========================================================================================
Not matching into an obstetrics and gynecology residency is extremely costly both in economic and applicant welfare terms.   A critical step in the prevention of not matching is the diagnosis of .  Machine learning, a subset of artificial intelligence, is the set of models and methods that can automatically detect patterns in vast amounts of data, extract information and use it to perform various kinds of decision-making under uncertain conditions.  

Machine learning (ML) classification algorithms have been used in a variety of applications, from the filtering of spam emails to the suggestion of movies a Netflix user might next enjoy. Machine learning may also become an indispensable tool for medical clinicians, with algorithms approaching problems much like a medical clinician progressing through their clinical training might; learning rules from data and applying them to new patients. The application of machine learning in the identification of disease has often focussed on image recognition.  Machine learning has been used within the field of obstetrics and gynecology, for example in attempting to predict fertility outcomes, and success of trial of labor after cesarean delivery.
...
3)  Medical schools often publish a list of where their students will be training  This is public information was hand searched from the internet.   
...
***However, it is more important to consider the false-positive rate than the false-negative rate for a model to predict matching; thus, we applied a partial AUC (pAUC) [20] to evaluate our proposed model. When using the maximum of false- positives as a fixed rate of 0.1, our proposed model achieved a pAUC of 0.931 ± 0.055, which is significantly higher (p � 0.048) than the pAUC of the RF using additional quantified parameters (pAUC: 0.864 ± 0.010; Figure 4). ***
