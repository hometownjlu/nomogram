...
dev.print(tiff, (here("results", "significant_numeric_variable_correlation.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
...
dplyr::mutate(white_non_white = as.integer(train$white_non_white),
  ...
  corrplot::corrplot(type="lower",
                     ...
                     pch = TRUE)
dev.print(tiff, (here("results", "train_correlation.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, dev.print(tiff, (here("results", "tm_nomogram_prep_kitchen_sink.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" , compression = "lzw"))
...
dev.print(tiff, (here("results", "hist_prediction_train.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "hist_prediction_test.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "forward_ROC.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
...
dev.print(tiff, (here("results", "Principal_Components_for_numeric_data.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
...
dev.print(tiff, (here("results", "scree_plot_PCA.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
...
# Print model summary
print(mars1)
dev.print(tiff, (here("results", "mars1_feature_selection.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
...
dev.print(tiff, (here("results", "mars1_model_selection.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "p1_and_p2.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "model_mars.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()

varimp_mars <- varImp(model_mars)
plot(varimp_mars, main="Variable Importance with MARS") #Visual of the most important factors
dev.print(tiff, (here("results", "varimp_mars.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
# Method 4: Variable Importance Scores
imps <- attStats(roughFixMod)
imps2 = imps[imps$decision != 'Rejected', c('meanImp', 'decision')]
head(imps2[order(-imps2$meanImp), ])  # descending sort
plot(boruta_output, cex.axis=0.35, las=2, xlab="", main="Boruta Variable Importance")  # Plot variable importance
dev.print(tiff, (here("results", "boruta_output_variable_importance")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "plot_lasso_mod.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "lasso_mod_plot.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
...
plot(ridge, xvar = "lambda", main = "Plot of Ridge Regression after Cross-Validations")
dev.print(tiff, (here("results", "ridge.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "ridgeandlassopenalty.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "ridge_lass_min_max.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "odds_ratio_image.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "cv_model3.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "varicable_importance_logistic_regression_glm.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "tm_rpart_plot.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "plotcp.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()

printcp(t.model)
dev.print(tiff, (here("results", "tree_sizes.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "plotcp_for_t_model2.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "vip_for_t.model3.plot.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "pruned_t_model.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
...
dev.print(tiff, (here("results", "SVM_ROC.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "rf_model_plot.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "Feature_importance_for_Random_Forest.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "tm_variable_importance_caret_matrix.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "XGBoost_Feature_Importance.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "train_lrm_with_lasso_variables.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "calibration_plot.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
...
dev.print(tiff, (here("results", "dotplot.tiff")), compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
#MUST SAVE THIS!!!!
```
