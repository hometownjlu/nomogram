...
index_1 <- sample(1:nrow(all_data), round(nrow(all_data) * 0.8))
...
set.seed(123)  # for reproducibility
split_1  <- initial_split(all_data, prop = 0.8)
train_3  <- training(split_1)
test_3   <- testing(split_1)

# Using h2o package
all_data.h2o <- as.h2o(all_data)
split_2 <- h2o.splitFrame(all_data.h2o, ratios = 0.8, 
                          seed = 123)
train_4 <- split_2[[1]]
test_4  <- split_2[[2]]
data_split
