...
chisq.test(train$Racegrp,train$Match_Status,correct = FALSE)#Racegroup is significant
...
dev.print(tiff, '~/Dropbox/Nomogram/nomogram/results/plot_significant_numeric_variable_correlation.tiff', compression = "lzw",width=2000, height=2000, bg="transparent", res = 200, units = "px" )
dev.off()
```
