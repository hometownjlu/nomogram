...
require(rms)
library(magrittr)
train1 <- train %>% dplyr::select(-Type_of_medical_school, -USMLE_Step_2_CK_Score, -USMLE_Step_1_Score, -US_or_Canadian_Applicant)
...
set.seed(123)  # for reproducibility
all_data <- all_data %>% select(-USMLE_Step_1_Score, -USMLE_Step_2_CK_Score) #%>%
