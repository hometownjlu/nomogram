...
#CREATE FUNCTION:  ggsave(paste0("from_npi_physician_class", format(Sys.time(),'_%Y%m%d_%H%M%S'), ".png"), plot = last_plot(), device = "png", scale = 1, width = 12, height = 10, units = c("cm"), dpi = 500,  bg = "transparent")
