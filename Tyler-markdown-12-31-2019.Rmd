...
# I want to use packrate to make the project more: isolated, portable and reproducible.  Please see packrat/packrat.lock for a list of the precise packages used and their versions.  
packrat::packrat_mode(on = TRUE)
packrat::snapshot() #Run each time a new library is installed.  
