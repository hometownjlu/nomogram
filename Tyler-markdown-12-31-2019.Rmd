...
scatterplotMatrix(~Age+USMLE_Step_1_Score, data=train, main="Correlations of Numeric Variables in the Cars Data")
...
#Feature Selection: Genetic algo
...
ga_GA_1 = ga(fitness = function(vars) custom_fitness(vars = vars, 
             ...
             elitism = 5, # number of best ind. to pass to next iteration
